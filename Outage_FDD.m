%Simulation for Outage Probability FDD scheme 
...
for k = 1:4:40 
    ...
    h3=h1;%f*(randn(1,N)+1j*randn(1,N));
    ...
    h31=h11;%eta*h3+sqrt(1-eta2)*f*(randn(1,N)+1j*randn(1,N));
    ...
    g3=g1;%rho*h3+sqrt(1-rho2)*f*(randn(1,N)+1j*randn(1,N));
    ...
    g31=g11;%rho*h31+sqrt(1-rho2)*f*(randn(1,N)+1j*randn(1,N));
    g41=g21;%rho*h41+sqrt(1-rho2)*f*(randn(1,N)+1j*randn(1,N));
    
    [gg1,gg2,hh1,hh2] = antenna_select_FDD(g1,g11,g2,g21,g3,g31,g4,g41,h1,h11,h2,h21,h3,h31,h4,h41,N);
